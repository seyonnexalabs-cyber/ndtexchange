...
export const metadata: Metadata = {
  ...
  description: 'NDT Connect is a purpose-built digital ecosystem connecting asset owners with certified NDT professionals to ensure operational continuity and grow businesses.',
};
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <main className="flex-grow">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="mt-6 text-lg md:text-xl text-primary-foreground/80">
                NDT Connect is a purpose-built ecosystem where asset owners ensure operational continuity and certified NDT professionals find opportunities to grow their business.
              </p>
        ...
        {/* What is NDT Connect Section - REVISED */}
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center">
                    ...
                    <p className="mt-4 max-w-3xl mx-auto text-lg text-muted-foreground">
                        NDT Connect is more than a marketplace. It's a unified platform providing dedicated toolsets for every stakeholder in the inspection lifecycle.
                    </p>
                </div>
