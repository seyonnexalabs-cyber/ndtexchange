                ...
                <CardContent>
                    <ScrollArea className="h-[60vh] pr-6">
                        <div className="space-y-6 text-muted-foreground">
                            ...
                            <h2 className="text-xl font-headline text-foreground pt-4">1. Definitions</h2>
                            <p>
                            The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and all Agreements: "Client", "You" and "Your" refers to you, the person log on this website and compliant to the Company’s terms and conditions. "The Company", "Ourselves", "We", "Our" and "Us", refers to our Company. "Party", "Parties", or "Us", refers to both the Client and ourselves.
                            </p>

                            <h2 className="text-xl font-headline text-foreground pt-4">2. License to Use Website</h2>
                            <p>
                            ...
                            <h2 className="text-xl font-headline text-foreground pt-4">3. User Content</h2>
                            <p>
                            ...
                            <h2 className="text-xl font-headline text-foreground pt-4">4. Role of the Platform & Disclaimer of Services</h2>
                            <p>
                            ...
                            <h2 className="text-xl font-headline text-foreground pt-4">5. Limitation of Liability</h2>
                            <p>
                            ...
                            <h2 className="text-xl font-headline text-foreground pt-4">6. Financial Transactions</h2>
                            <p>
                            ...
                            <h2 className="text-xl font-headline text-foreground pt-4">7. Governing Law & Jurisdiction</h2>
                            <p>
