...
export default function NDTSetupBuilderTrialPage() {
      ...
      <main className="flex-grow flex flex-col relative p-4 lg:p-6 bg-muted/30">
        <div className="mb-4">
          <Alert>
            ...
            <AlertDescription>
              This trial version is for exploring the NDT Setup Builder. To save your designs and attach them to jobs, please <Link href="/signup" className="underline font-semibold hover:text-primary">sign up for a free account</Link>.
            </AlertDescription>
          </Alert>
        </div>
        <div className="flex-grow h-0">
          <NDTSetupBuilder isTrial={true} />
        </div>
      </main>
    </div>
  );
