...
const userDetails = {
    client: { name: 'John Doe', role: 'Project Manager', email: 'john.d@globalenergy.corp', avatar: 'user-avatar-client', fallback: 'JD' },
    inspector: { name: 'Jane Smith', role: 'Level II Inspector', email: 'jane.s@acmeinspection.com', avatar: 'user-avatar-inspector', fallback: 'JS' },
    admin: { name: 'Admin User', role: 'Platform Admin', email: 'admin@ndtexchange.com', avatar: 'user-avatar-admin', fallback: 'AU' },
    auditor: { name: 'Alex Chen', role: 'Compliance Auditor', email: 'alex.c@ndtauditors.gov', avatar: 'user-avatar-auditor', fallback: 'AC' },
};
