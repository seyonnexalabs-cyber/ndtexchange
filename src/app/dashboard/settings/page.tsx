      ...
      <Tabs defaultValue="profile" className="w-full">
        ...
        <TabsContent value="terms">
            <Card>
                ...
                <CardContent>
                    <p className="text-muted-foreground">Your use of the NDT Exchange platform is subject to our Terms and Conditions. You can review the full, up-to-date document on our public site.</p>
                </CardContent>
                 <CardFooter>
                    <Button asChild>
                        <Link href="/terms" target="_blank">View Full Terms and Conditions</Link>
                    </Button>
                </CardFooter>
            </Card>
        </TabsContent>
