...
export const productsData: Product[] = [
    ...
    { id: 'PROD-028', name: 'Zetec Topaz64', manufacturerId: 'manu-03', manufacturerName: 'Zetec', type: 'Instrument', techniques: ['PAUT'], description: 'A fully integrated, portable 64-channel phased array ultrasonic instrument with real-time TFM.', imageUrls: [] },
...
export const bidsData: Bid[] = [
    { id: 'BID-PERFECT', clientCompanyId: 'client-01', userId: 'nxHzdOkwW6RLPWEgVvVbHyzN8OR2', jobId: 'JOB-PERFECT', inspectorId: 'NAXP822MG6cWlaCNkaqkYpxDRmQ2', providerCompanyId: 'provider-03', amount: 18500, status: 'Awarded', submittedDate: '2024-07-02T14:00:00Z', comments: 'Experienced team ready to deploy for this scope.', client: 'Global Energy Corp.', location: 'Houston, TX', jobTitle: 'Perfect Lifecycle Demo Job' },
    { id: 'BID-PERFECT-2', clientCompanyId: 'client-01', userId: 'nxHzdOkwW6RLPWEgVvVbHyzN8OR2', jobId: 'JOB-PERFECT', inspectorId: 'user-tech-01', providerCompanyId: 'provider-01', amount: 21000, status: 'Not Selected', submittedDate: '2024-07-03T10:00:00Z', comments: 'Full team availability guaranteed.', client: 'Global Energy Corp.', location: 'Houston, TX', jobTitle: 'Perfect Lifecycle Demo Job' },
    { id: 'BID-PERFECT-3', clientCompanyId: 'client-01', userId: 'nxHzdOkwW6RLPWEgVvVbHyzN8OR2', jobId: 'JOB-PERFECT', inspectorId: 'user-tech-02', providerCompanyId: 'provider-02', amount: 19500, status: 'Not Selected', submittedDate: '2024-07-03T11:30:00Z', comments: 'We have local technicians available.', client: 'Global Energy Corp.', location: 'Houston, TX', jobTitle: 'Perfect Lifecycle Demo Job' },
    ...
    { id: 'BID-015', clientCompanyId: 'client-08', userId: 'nxHzdOkwW6RLPWEgVvVbHyzN8OR2', jobId: 'JOB-015', inspectorId: 'user-tech-01', providerCompanyId: 'provider-01', amount: 3500, status: 'Awarded', submittedDate: '2024-07-03', client: 'Manufacturing Solutions Inc.', location: 'Detroit, MI', jobTitle: 'Remote Visual Inspection of Gearbox' },
    { id: 'BID-016', clientCompanyId: 'client-02', userId: 'user-client-02', jobId: 'JOB-016', inspectorId: 'user-tech-02', providerCompanyId: 'provider-02', amount: 14000, status: 'Submitted', submittedDate: '2024-07-24', client: 'Marine Tankers Ltd.', location: 'New Orleans, LA', jobTitle: 'Tank Floor Corrosion Mapping' },
    { id: 'BID-017', clientCompanyId: 'client-01', userId: 'nxHzdOkwW6RLPWEgVvVbHyzN8OR2', jobId: 'JOB-017', inspectorId: 'NAXP822MG6cWlaCNkaqkYpxDRmQ2', providerCompanyId: 'provider-03', amount: 9500, status: 'Awarded', submittedDate: '2024-07-26', client: 'Global Energy Corp.', location: 'Houston, TX', jobTitle: 'Shutdown Support - PT' },
    { id: 'BID-018', clientCompanyId: 'client-09', userId: 'user-client-05', jobId: 'JOB-018', inspectorId: 'user-tech-01', providerCompanyId: 'provider-01', amount: 25000, status: 'Submitted', submittedDate: '2024-07-29', client: 'Aviation Maintenance Pros', location: 'Wichita, KS', jobTitle: 'Landing Gear Weld Inspection' },
    { id: 'BID-019', clientCompanyId: 'client-09', userId: 'user-client-05', jobId: 'JOB-019', inspectorId: 'user-tech-01', providerCompanyId: 'provider-01', amount: 18000, status: 'Submitted', submittedDate: '2024-07-30', client: 'Aviation Maintenance Pros', location: 'Wichita, KS', jobTitle: 'Fuselage Skin Eddy Current Scan' },
...
export const subscriptions: Subscription[] = [
  { id: 'SUB-001', companyId: 'client-01', companyName: 'Global Energy Corp.', plan: 'Client Plus', status: 'Active', startDate: '2024-01-15', userCount: 25, dataUsageGB: 15.2, userLimit: 200, dataLimitGB: 50, assetLimit: 'Unlimited', equipmentLimit: 'Unlimited', biddingLimit: 'Unlimited' },
  { id: 'SUB-002', companyId: 'client-02', companyName: 'Marine Tankers Ltd.', plan: 'Client Access', status: 'Trialing', startDate: '2024-07-05', endDate: '2024-08-04', userCount: 5, dataUsageGB: 2.1, userLimit: 10, dataLimitGB: 20, assetLimit: 200, equipmentLimit: 0, biddingLimit: 0 },
  { id: 'SUB-003', companyId: 'provider-01', companyName: 'MISTRAS Group', plan: 'Company Growth', status: 'Active', startDate: '2024-03-20', userCount: 50, dataUsageGB: 45.8, userLimit: 50, dataLimitGB: 200, assetLimit: 0, equipmentLimit: 'Unlimited', biddingLimit: 'Unlimited' },
  { id: 'SUB-004', companyId: 'provider-02', companyName: 'Applus+', plan: 'Provider Pro', status: 'Past Due', startDate: '2023-11-10', userCount: 38, dataUsageGB: 32.5, userLimit: 75, dataLimitGB: 120, assetLimit: 0, equipmentLimit: 25, biddingLimit: 10 },
  { id: 'SUB-005', companyId: 'client-03', companyName: 'Energy Transfer', plan: 'Client Access', status: 'Canceled', startDate: '2024-02-01', endDate: '2024-05-01', userCount: 10, dataUsageGB: 8.7, userLimit: 10, dataLimitGB: 20, assetLimit: 200, equipmentLimit: 0, biddingLimit: 0 },
  { id: 'SUB-006', companyId: 'provider-04', companyName: 'TÜV Rheinland', plan: 'Company Growth', status: 'Active', startDate: '2024-06-01', userCount: 150, dataUsageGB: 88.1, userLimit: 150, dataLimitGB: 200, assetLimit: 0, equipmentLimit: 'Unlimited', biddingLimit: 'Unlimited' },
  { id: 'SUB-007', companyId: 'client-04', companyName: 'State DOT', plan: 'Client Access', status: 'Payment Failed', startDate: '2024-04-15', userCount: 8, dataUsageGB: 12.3, userLimit: 10, dataLimitGB: 20, assetLimit: 200, equipmentLimit: 0, biddingLimit: 0 },
  { id: 'SUB-008', companyId: 'auditor-firm-01', companyName: 'NDT Auditors LLC', plan: 'Free Access', status: 'Active', startDate: '2024-01-01', userCount: 2, dataUsageGB: 1.5, userLimit: 200, dataLimitGB: 500, assetLimit: 'Unlimited', equipmentLimit: 'Unlimited', biddingLimit: 'Unlimited' },
  { id: 'SUB-009', companyId: 'client-05', companyName: 'Chemical Plant C', plan: 'Client Access', status: 'Active', startDate: '2024-07-10', userCount: 3, dataUsageGB: 0.5, userLimit: 10, dataLimitGB: 20, assetLimit: 200, equipmentLimit: 0, biddingLimit: 0 },
  { id: 'SUB-010', companyId: 'provider-09', companyName: 'Blue Horizon Services', plan: 'Provider Pro', status: 'Active', startDate: '2024-07-20', userCount: 12, dataUsageGB: 4.5, userLimit: 50, dataLimitGB: 100, assetLimit: 0, equipmentLimit: 25, biddingLimit: 10 },
  { id: 'SUB-011', companyId: 'client-08', companyName: 'Manufacturing Solutions Inc.', plan: 'Client Access', status: 'Trialing', startDate: '2024-07-15', endDate: '2024-08-14', userCount: 2, dataUsageGB: 0.8, userLimit: 5, dataLimitGB: 5, assetLimit: 200, equipmentLimit: 0, biddingLimit: 0 },
  { id: 'SUB-012', companyId: 'client-09', companyName: 'Aviation Maintenance Pros', plan: 'Client Plus', status: 'Active', startDate: '2024-07-25', userCount: 1, dataUsageGB: 0.1, userLimit: 200, dataLimitGB: 50, assetLimit: 'Unlimited', equipmentLimit: 'Unlimited', biddingLimit: 'Unlimited' },
  { id: 'SUB-013', companyId: 'provider-11', companyName: 'SGS', plan: 'Provider Pro', status: 'Active', startDate: '2024-07-26', userCount: 2, dataUsageGB: 0.3, userLimit: 50, dataLimitGB: 100, assetLimit: 0, equipmentLimit: 25, biddingLimit: 10 },
  { id: 'SUB-014', companyId: 'provider-12', companyName: 'DNV (Det Norske Veritas)', plan: 'Company Growth', status: 'Active', startDate: '2024-06-10', userCount: 1, dataUsageGB: 2.5, userLimit: 200, dataLimitGB: 500, assetLimit: 'Unlimited', equipmentLimit: 'Unlimited', biddingLimit: 'Unlimited' },
  { id: 'SUB-015', companyId: 'provider-03', companyName: 'TEAM, Inc.', plan: 'Company Growth', status: 'Active', startDate: '2024-01-01', userCount: 3, dataUsageGB: 10, userLimit: 15, dataLimitGB: 75, assetLimit: 'Unlimited', equipmentLimit: 'Unlimited', biddingLimit: 'Unlimited' },
  { id: 'SUB-ADMIN', companyId: 'provider-ndtx', companyName: 'NDT EXCHANGE', plan: 'Platform Admin', status: 'Active', startDate: '2024-01-01', userCount: 2, dataUsageGB: 25, userLimit: 9999, dataLimitGB: 9999, assetLimit: 'Unlimited', equipmentLimit: 'Unlimited', biddingLimit: 'Unlimited' },
];
...
export const subscriptionPlans: Plan[] = [
    // Client Plans
    {
        ...
        description: "For plants, EPCs, and pilot teams to test key features.",
        userLimit: 5,
        dataLimitGB: 2,
        assetLimit: 200,
        biddingLimit: 0,
        ...
        userCredits: 5,
        dataCreditsGB: 2,
        overagePricePerUserUSD: 15,
        overagePricePer10GBUSD: 10,
        features: [
            '30-day free trial with full Client Access',
    ...
    },
    {
        ...
        description: "Enterprise-grade support, security, and integrations.",
        userLimit: 'Unlimited',
        dataLimitGB: 'Unlimited',
        assetLimit: 'Unlimited',
        ...
        isActive: true,
        features: [
            "All Client Plus features",
            "Custom API integrations",
            "Advanced security and SSO support",
    ...
    // Provider Plans
    {
        ...
        priceDescription: 'Free 30-day trial',
        description: "For individual inspectors getting started with core marketplace tools.",
        userLimit: 1,
        dataLimitGB: 1,
        assetLimit: 0,
        biddingLimit: 1,
    ...
    },
    {
        ...
        priceDescription: '/ month (USD)',
        description: "For auditors requiring team collaboration and analytics.",
        userLimit: 'Unlimited',
        dataLimitGB: 1000,
        assetLimit: 'Unlimited',
        biddingLimit: 'Unlimited',
        ...
        isActive: true,
        features: [
            "All Auditor Free Access features",
            "Batch audit planning and compliance dashboards",
            "Data export APIs",
            "Priority support for audit audits",
        ],
    }
];
