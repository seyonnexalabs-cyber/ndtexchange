...
export const productsData: Product[] = [
    ...
    { id: 'PROD-024', name: 'ROSEN RoCorr MFL-A', manufacturerId: 'manu-14', manufacturerName: 'Rosen Group', type: 'Instrument', techniques: ['MFL'], description: 'High-resolution MFL-A technology for pipeline inspection.', imageUrls: [] },
...
export const allUsers: PlatformUser[] = [
    ...
    { id: 'user-manu-01', name: 'OEM User', email: 'oem.user@evident.com', role: 'Manufacturer', companyId: 'manu-01', company: 'Evident Scientific', status: 'Active', password: 'password123', createdAt: '2024-07-30T10:00:00Z' },
